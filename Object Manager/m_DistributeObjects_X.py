...
Website:
Version: 1.0.0
Description-US: Distribute selected objects along the X-axis ALT: Input gap value.
"""
...
def main():
    ...
    for obj in objs:
        ...
        offset = currentX - bbox_min.x
        pos = obj.GetAbsPos() + c4d.Vector(offset, 0, 0)
        obj.SetAbsPos(pos)
        currentX = bbox_max.x + offset
        if gap_enabled:
            currentX += gap_value
