...
def main():
    ...
    # Diccionario que contendrá los nulls de agrupación creados (se crean solo si se asigna algún objeto)
    groups = {}
    # Datos de cada categoría: nombre y color de display.
    groups_info = {
    ...
    for obj in allObjects:
        ...
        # Se asigna a "Generators" si se encuentra un cloner en la rama O si el objeto es un Volume Builder.
