...
Website:
Version: 1.0.0
Description-US: Distribute selected objects along the Y-axis ALT: Input gap value.
"""
...
def main():
    ...
    for obj in objs:
        ...
        offset = currentY - bbox_min.y
        pos = obj.GetAbsPos() + c4d.Vector(0, offset, 0)
        obj.SetAbsPos(pos)
        currentY = bbox_max.y + offset
        if gap_enabled:
            currentY += gap_value
